...
import { RECENT_POSTS_BREADCRUMB } from './../../core/constans/breadcrumbs.constants';
import { Component, OnInit } from '@angular/core';
import { PostsService } from './../../core/services/post.service';

@Component({
  selector: 'app-categories-last',
  templateUrl: './categories-last.component.html',
  styleUrls: ['./categories-last.component.scss',
              '../categories-all/categories-all.component.scss']
})
export class CategoriesLastComponent implements OnInit {
  ...
  ngOnInit() {
    this.getPosts();
    this.breadcrumbsService.breadcrumbsSubject.next([RECENT_POSTS_BREADCRUMB]);
  }
